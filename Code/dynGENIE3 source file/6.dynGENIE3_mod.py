# -*- coding: utf-8 -*-
"""
Created on Sat Aug  7 23:58:01 2021

@author: user
"""

from sklearn.tree import BaseDecisionTree, DecisionTreeClassifier,ExtraTreeClassifier, export_graphviz, export_text, plot_tree  
...
def get_link_list(VIM,gene_names=None,regulators='all',maxcount='all',file_name=None):
    ...
    if regulators == 'all':
        input_idx = list(range(ngenes)) #range(ngenes) produces 0,1,2...ngenes-1
    else:
